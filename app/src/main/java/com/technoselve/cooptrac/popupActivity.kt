...
//            val (score, recs) = calculateTotalScore(selectedCategory, answers)
...
//        }) {
                                ...
                                val dynamicHeight = when (val questionCount = filteredQuestions.size) {
                                    ...
                                    in 1..5 -> 0.5f  // Moderate height for a few questions
                                        ...
                                        Column(
                                            ...
                                            if (filteredQuestions.isNotEmpty()) {
                                                filteredQuestions.forEach { question ->
                                                    key(question.id) {
                                                        Log.d("PopupActivity", "PopupActivity Before PercentageSliderQuestion: $tempAnswers")
                                                        when (question.type) {
                                            ...
                                            val error = validationErrorState.value.values.any { it != null }
...
//                            if (surveyDate.isEqual(today)) {
                                                Button(
                                                    ...
                                                    modifier = Modifier.weight(1f) // Adjusts the space for the button
                                                ) {
                                                    Text(text = "Clear")
                                                }
                                                ...
                                                Button(
                                                    ...
                                                    colors = ButtonDefaults.buttonColors(
                                                        containerColor = if (isEditable) colorResource(id = R.color.turquoise) else Color.DarkGray,
                                                        )
...
//    highlightUnanswered: Boolean
                        ...
                        fun isValidPhoneNumber(phone: String): Boolean {
                            ...
                            val phoneRegex = Regex("^\\+?[1-9][0-9]{7,14}$") // Allows optional "+" and 8-15 digits
...
////                            }
////                            else
//                            if (previousAnswerDouble6 != null && currentAnswer == previousAnswerDouble6) {
...
//}
                    ...
                    fun PercentageSliderQuestion(
                        ...
                        // Update the answers map when user changes the slider value
//    LaunchedEffect(userAnswer) {
//        if (!isReadOnly) {
//            answers[question.id] = userAnswer
//            Log.d("PercentageSliderUpdate", "Updated answers[${question.id}]: $userAnswer")
//        }
//    }
