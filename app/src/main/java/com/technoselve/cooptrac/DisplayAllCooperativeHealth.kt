                        ...
                        DropdownMenuItem(
                            ...
                            onClick = {
                                ...
                                if (selectedSurveys.isNotEmpty()) {
                                    ...
                                    Toast.makeText(context, "No surveys selected", Toast.LENGTH_SHORT).show()
                                }
                ...
                Row(
                    ...
                    if (surveys.isNotEmpty()) {
                        Box(
                            ...
                            Text(
                                text = if(selectedLanguage=="English "){"Click on each section to view details and recommendations"} else {"Kanda kuri buri gice urebe ibisobanuro n'ibyifuzo"},
                                color = Color.White,
                    ...
                    if (filteredSurveys.isEmpty()) {
                        item {
                            Box(
                                ...
                                Text(
                                    text = if (selectedLanguage == "English") "No results found." else "Nta byabonetse.",
